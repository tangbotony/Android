...
public class SM extends RelativeLayout {
	...
	public SM(Context context, AttributeSet attrs) {
		super(context, attrs);
		printTheFlags("before init");
		init(context);
		printTheFlags("after init");
	}

	public SM(Context context, AttributeSet attrs, int defStyle) {
	...
	public void showLeftView() {
		...
		printTheFlags("end showLeft");
	}

	/* 显示右侧边的view */
	public void showRightView() {
		printTheFlags("start showRight");
	...
	private void printTheFlags(String str) {

		Li.printlnLog("why---" + str);
		Li.printlnLog("why---mIsBeingDragged--" + mIsBeingDragged);
		Li.printlnLog("why---tCanSlideLeft--" + tCanSlideLeft);
		Li.printlnLog("why---tCanSlideRight--" + tCanSlideRight);
		Li.printlnLog("why---hasClickLeft--" + hasClickLeft);
		Li.printlnLog("why---hasClickRight--" + hasClickRight);
		Li.printlnLog("why---canSlideLeft--" + canSlideLeft);
		Li.printlnLog("why---canSlideRight--" + canSlideRight);
	}
}
