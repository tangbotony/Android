...
public class Dow {
	...
	public int downloadUpdateFile(String downloadUrl, File saveFile,String fileName, Do callback,Context context)
            throws Exception {
        ...
        try {
            ...
            //fos = context.openFileOutput(fileName, Context.MODE_APPEND+Context.MODE_WORLD_READABLE+Context.MODE_WORLD_WRITEABLE);
